...
declare class ElementBuilder {
    ...
    private _removeProp;
    detached<T>(fn: () => T): T;
    el: <T extends keyof HTMLElementTagNameMap | keyof SVGElementTagNameMap>(tagName: T, propsOrCb?: BuilderProps | (() => void), cb?: () => void) => T extends keyof HTMLElementTagNameMap ? HTMLElementTagNameMap[T] : T extends keyof SVGElementTagNameMap ? SVGElementTagNameMap[T] : Element;
