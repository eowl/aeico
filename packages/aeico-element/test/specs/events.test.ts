...
describe('emit()', () => {
  it('dispatches a CustomEvent on the target', () => {
    ...
    el.addEventListener('my-event', (e) => { received = e as CustomEvent })
  ...
  it('event bubbles by default', () => {
    ...
    let bubbled = false
    parent.addEventListener('bubble-test', () => { bubbled = true })
  ...
  it('event is composed by default', () => {
    const el = document.createElement('div')
    let ev: unknown = null
    el.addEventListener('composed-test', (e) => { ev = e })
  ...
  it('attaches detail payload to the event', () => {
    ...
    el.addEventListener('detail-event', (e) => { detail = (e as CustomEvent).detail })
  ...
  it('bubbles=false prevents event from bubbling', () => {
    ...
    let bubbled = false
    parent.addEventListener('no-bubble', () => { bubbled = true })
  ...
  it('composed=false prevents event from crossing shadow DOM boundary', () => {
    ...
    let crossed = false
    host.addEventListener('shadow-event', () => { crossed = true })
...
describe('ListenerRegistry', () => {
  it('adds an event listener to a target', () => {
    ...
    let fired = false
    registry.add(el, 'click', () => { fired = true })
  ...
  it('supports listeners on multiple targets', () => {
    ...
    const registry = new ListenerRegistry()
    let count = 0
    registry.add(a, 'click', () => { count++ })
    registry.add(b, 'click', () => { count++ })
